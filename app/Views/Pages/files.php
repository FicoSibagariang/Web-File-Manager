      ...
      <div class="row align-items-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
          ...
          <div class="pt-20 rounded-top no-repeat; background-size: cover; mt-3" style="border-radius: 0px 0px 5px 5px;">
            <div style="width: 100%; height: 130px; border-radius: 5px 5px 0px 0px; background-color:darkblue"></div>
          </div>
          <!-- text -->
          <div class="card rounded-bottom smooth-shadow-sm ">
            <div class="d-flex align-items-center justify-content-between pb-4 px-4" style="height: 120px; margin-top:50px;">
              ...
              <div>
                <a href="profile-edit.html" class="btn btn-outline-primary d-none d-md-block">
                  Edit Profile
                </a>
              </div>
            </div>
          ...
          <div class="col-md-12 col-12">
            ...
            <div class="card mb-3 mt-5">
              ...
              <div class="card-body">
                ...
                align-items-center">
                  <div>
                    <i class="far fa-file-excel fa-2x mr-1"></i>
                  </div>
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="far fa-file-image fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="far fa-file fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="fas fa-table fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="far fa-file-powerpoint fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="fas fa-font fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="row justify-content-between
                      align-items-center">
                  <div>
                    <i class="far fa-file-video fa-2x mr-1"></i>
                  </div>
                  <div class="d-flex col-lg-6 col-12
                        mb-4 mb-lg-0">
                    <div class="ms-3">
