        ...
        table = $("#tabel_data").DataTable({
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row) {
                    if (row[4] == "0") {
                        return "<div class=\"d-inline mx-1\"><a class=\"btn btn-md btn-warning\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit(" + row[5] + ")\"> Ubah</a></div><div class=\"d-inline mx-1\"><a class=\"btn btn-md btn-danger\" href=\"javascript:void(0)\" title=\"Delete\"  onclick=\"deldata(" + row[5] + ")\"><i class=\"fas fa-trash\"></i> Hapus Project</a></div>"
                    } else {
                        return "<div class=\"d-inline mx-1\"><a class=\"btn btn-md btn-warning\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit(" + row[5] + ")\"> Ubah</a></div> <div class=\"d-inline mx-1\"><a class=\"btn btn-md btn-danger\" href=\"javascript:void(0)\" title=\"Hapus Project\" onclick=\"riset(" + row[5] + ")\"><i></i> Hapus Project</a></div>";
                    }
                },
